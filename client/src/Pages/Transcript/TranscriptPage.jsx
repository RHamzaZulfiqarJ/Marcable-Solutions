  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center flex-col py-2">
          <p className="text-center">&copy; Right Reserverd by Marcable Solutions</p>
          <p className="text-center">info@marcablesolution.com</p>
          <p className="text-center">301 2nd Floor, Gulberg 3, Lahore, Pakistan.</p>
      </div>
    </div>
  );
};
