...
const AcceptLead = ({ setOpen, open, scroll, fieldData, userId, leadId }) => {
  ...
  let initialLeadState = {
    clientName: fieldData ? fieldData.find(field => field.name === 'full_name')?.values[0] : "",
    clientPhone: fieldData ? fieldData.find(field => field.name === 'phone_number')?.values[0] : "",
    city: fieldData ? fieldData.find(field => field.name === 'city')?.values[0] : "",
    description: "",
    property: "",
    area: fieldData ? fieldData.find(field => field.name === 'area')?.values[0] : "",
    priority: "",
    status: "newClient",
    source: "facebook",
  };
    ...
    <div>
      <Dialog
        ...
        <DialogTitle className="flex items-center justify-between">
          <div className="text-sky-400 font-primary">Complete Lead Information to Accept the Lead</div>
        ...
        <DialogContent>
          ...
          <div className="flex flex-col gap-2 p-3 text-gray-500 font-primary">
            ...
            <table className="mt-4">
              ...
              <tr>
                <td className="flex flex-col justify-start mt-1 text-lg">Follow Up Description </td>
                <td className="pb-4">
                  <TextField
