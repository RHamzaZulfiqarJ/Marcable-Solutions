...
export const getLead = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ result: findedLead, message: "Lead fetched successfully", success: true });
  } catch (err) {
...
export const getLeads = async (req, res, next) => {
  try {
    const findedLeads = await Lead.find()
      .populate("client")
    ...
    res
      .status(200)
      .json({ result: findedLeads, message: "Leads fetched successfully", success: true });
  } catch (err) {
    next(createError(500, err.message));
  }
};
...
export const getLeadByPhone = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ result: findedLead, followUps, message: "Lead fetched successfully", success: true });
  } catch (err) {
    next(createError(500, err.message));
  }
};
...
export const deleteLead = async (req, res, next) => {
  try {
    ...
    res
      ...
      .json({
        result: deletedLead,
        message: "Lead and associated follow-ups deleted successfully",
        success: true,
      });
  } catch (err) {
    next(createError(500, err.message));
...
export const deleteWholeCollection = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ result, message: "Lead collection deleted successfully", success: true });
  } catch (err) {
    next(createError(500, err.message));
  }
};
